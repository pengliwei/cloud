...
import com.awei.ad.search.vo.media.App;
import com.awei.ad.search.vo.media.Device;
import com.awei.ad.search.vo.media.Geo;
...
public class SearchTest {
    ...
    public void testFetchAds(){
        ...
        request.setMediaId("awei");
        // 第一个测试条件
        request.setRequestInfo(new SearchRequest.RequestInfo("aaa",
                Collections.singletonList(new AdSlot( "ad-x", 1,
